...
const urls = [
  ...
  "https://gissd.sandag.org/rdw/rest/services/Zoning/Zoning/MapServer",
  "https://webmaps.sandiego.gov/arcgis/rest/services/DSD/Zoning_Base/MapServer",
  "https://services7.arcgis.com/feBzKmbMMjDq2yKj/ArcGIS/rest/services/NRT_Trail_Data_ESRI_web_2017_11_26/FeatureServer/",
  "https://idpgis.ncep.noaa.gov/arcgis/rest/services/NWS/USGS_Stream_Gauges/MapServer/", //stream gages
  "https://services.gis.ca.gov/arcgis/rest/services/Transportation/HSR_OppZone/MapServer/", //CA Opportunity zones
  "https://services3.arcgis.com/xTjSNSS8uiNdYSaW/ArcGIS/rest/services/epasld_places/FeatureServer/",
];
  ...
  const layers = await cache.featureServiceToGeoJSON(urls[2],
    {
      ...
      prefix: "cache_", //prefix to add to the start of layer names
